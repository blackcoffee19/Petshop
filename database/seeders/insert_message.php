...
class insert_message extends Seeder
{
    ...
    {
        $messages = [
            ['code_group'=>"UCT53","id_user"=>5,'message'=>"Which type of scorpion has the strongest venom?",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '19/01/2023 00:00:00')],
            ['code_group'=>"UCT53","id_user"=>3,'message'=>"I think you can check scorpion Sha or June",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '19/01/2023 00:00:00')],
            ['code_group'=>"UCT53","id_user"=>5,'message'=>"Ok thanks",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '20/01/2023 09:20:00')],
            ['code_group'=>"UCT53","id_user"=>5,'message'=>"Is Emma here?",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '24/01/2023 12:00:00')],
            ['code_group'=>"UCT53","id_user"=>3,'message'=>"Yes?",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '24/01/2023 12:30:00')],
            ...
            ["id_user"=>4,'message'=>"I'm finding a rabbit",'created_at'=>Carbon::createFromFormat('d/m/Y H:i:s',  '03/04/2023 08:43:00')],
