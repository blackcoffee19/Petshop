<footer class="footer">
    <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-lg-6">
              ...
              <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="{{route('productlist',[$type->name_type,$breed->breed_name])}}" class="nav-link">{{$breed->breed_name}}</a></li>
                @endforeach
              </ul>
            </div>                
            @endforeach
          ...
          <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
            <ul class="list-inline mb-0">
              ...
              <li class="list-inline-item">
                <a href="#!"><img src="resources/image/payment/amazonpay.svg" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="resources/image/payment/american-express.svg" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="resources/image/payment//mastercard.svg" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="resources/image/payment/paypal.svg" alt=""></a>
              </li>
              <li class="list-inline-item">
                <a href="#!"><img src="resources/image/payment/visa.svg" alt=""></a>
              </li>
            </ul>
          </div>
          <div class="col-lg-7 mt-4 mt-md-0">
            <ul class="list-inline mb-0 text-lg-end text-center">
              ...
              <li class="list-inline-item ms-4">
                <a href="#!"> <img src="resources/image/appbutton/appstore-btn.svg" alt=""
                    style="width: 140px;"></a></li>
              <li class="list-inline-item">
                <a href="#!"> <img src="resources/image/appbutton/googleplay-btn.svg" alt=""
                    style="width: 140px;"></a></li>
            </ul>
          </div>
        </div>
      ...
      <div class="border-top py-4">
        <div class="row align-items-center">
          <div class="col-md-6"><span class="small text-muted">Copyright 2023 © CatTuong.</span></div>
          <div class="col-md-6">
            <ul class="list-inline text-md-end mb-0 small mt-3 mt-md-0">
              <li class="list-inline-item text-muted">Follow us on</li>
              <li class="list-inline-item me-1">
                <a href="https://www.facebook.com/black.coffee.shrimp/" class="btn btn-xs btn-social btn-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
              ...
              <li class="list-inline-item me-1">
                <a href="https://twitter.com/blackcoffee19vn" class="btn btn-xs btn-social btn-icon"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
